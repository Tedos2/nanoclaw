      ...
      for (const msg of messages) {
        try {
          ...
          if (groups[chatJid]) {
            ...
            // Image attachment handling — download, resize, and replace content
            // with a marker that the agent-runner picks up for multimodal input.
            ...
            // PDF attachment handling — download to attachments/, content becomes
            // a [PDF: ...] marker so the agent can run pdf-reader in its container.
